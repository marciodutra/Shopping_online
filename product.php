					...
					<?php 
							...
							<div class="col-md-5">
								<div class="product-details">
									...
									<div>
										<h3 class="product-price">$'.$row['product_price'].'<del class="product-old-price">R$990.00</del></h3>
									...
									<div class="add-to-cart">
										...
										<button class="add-to-cart-btn" pid="'.$row['product_id'].'"  id="product" ><i class="fa fa-shopping-cart"></i>Adicionar ao carrinho</button>
										</div>
									...
									<ul class="product-btns">
										<li><a href="#" pid="'.$row['product_id'].'"  id="wishlist" ><i class="fa fa-heart-o"></i> Adicionar a lista de desejos</a></li>
										...
										<div class="col-md-3 mainn">
											<div id="review-form">
												<form class="review-form" onsubmit="return false" id="review_form" required>
													...
													<textarea class="input" name="review" placeholder="Sua revisão"></textarea>
													...
													<button class="primary-btn" name="review_submit">Enviar</button>
												</form>
											</div>
										</div>
										<!-- /Review Form -->
