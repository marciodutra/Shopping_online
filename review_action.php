    ...
    <div class="col-md-6">
        <div id="reviews">
            ...
            if ($r_count > 0){
                ...
                echo'<p>Sem comentários ainda seja a primeira pessoa a avaliar o produto</p>';
            }
...
if(isset($_POST["rating_reviews"])){
    ...
    $rating_query = "SELECT ROUND(AVG(rating),1) AS avg_rating, COUNT(*) AS count FROM reviews WHERE product_id='$p_id'";
            ...
            <a class="review-link" href="#review-form">'.$r_count.' Revisão(ões) | Adicione seu comentário</a>
            ';
            }
